...
var data_template = {
	...
	<div class="music-card-body">
		...
		<div class="btn-sm btn-sm-more">
			<div class="dropdown-content">
				<a href="javascript:void(0);" onclick="player.add_song_to_list('{{song_id}}')">Add to Playlist</a>
				{{vocals_link}}
				<a href="{{song_path}}" download="{{name}}">Download</a>
			</div>
		</div>
	</div>
</div>`,
	...
	<div class="album-card-body">
		...
		<div class="btn-sm btn-sm-more">
			<div class="dropdown-content">
				<a href="javascript:void(0);" onclick="player.add_album_to_list('{{name}}')">Add to Playlist</a>
				<a href="javascript:void(0);" onclick="app.switch_app(app_album,'{{name}}')">View</a>
			</div>
		</div>
	</div>
</div>`,
	...
	<a class="playlist-btn-primary" href="{{song_path}}" download="{{name}}">Download</a>
	<div class="playlist-btn-primary" onclick="player.add_song_to_list('{{song_id}}')">Add to Playlist</div>
</div>`,
	'playlist-item': `<div class="playlist-song">
	<div class="nav-btn-play btn-playlist" data-btn-play="{{song_id}}" onclick="ui.btn_playlist_play_pause('{{song_id}}')"></div>
	<div class="playlist-song-name" onclick="ui.btn_playlist_play_pause('{{song_id}}')">{{name}}</div>
	{{vocals_link}}
	<div class="playlist-btn-remove" onclick="player.delete_song_from_list('{{song_id}}')">Delete</div>
</div>`,
